...
Visual Validation Toolkit, with twenty paper examples across four model
collections and a light theme. Continuous parameter editing uses precomputed
Blender geometry data and preserves the source part dependencies, attachment
coordinates, and baked base colors. Edited previews do not reuse saved
validation results. Blender execution and validation remain available in the
local toolkit.
